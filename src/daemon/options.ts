...
const fields = new Set(['issuer', 'clientId', 'redirectUri', 'discoveryUrl', 'scopes', 'timeoutMs', 'authorizationParams']);
...
export function loginOptions(body: unknown): AuthorizationOptions {
  ...
  return { issuer: body.issuer as string, clientId: body.clientId as string, redirectUri: body.redirectUri as string,
    ...
    timeoutMs: timeoutMs as number, authorizationParams: body.authorizationParams as Record<string, string> | undefined };
}
